...
public:
  ...
  void declareArguments(const string &suffix="")
  {
    ...
    declare(suffix,"list-subzone","Query that lists all records on and below the given name.","select content,ttl,prio,type,domain_id,name from records where (name=E'%s' OR name like E'%s') and domain_id=%d");
    ...
    declare(suffix,"update-record-query", "Query that updates records with the prio", "update records set content=E'%s', ttl=%d, prio=%d where name=E'%s' and type=E'%s' and domain_id=%d and content=E'%s' and prio=%d");
    declare(suffix,"update-record-query-no-prio", "Query that updates record without the prio", "update records set content=E'%s', ttl=%d where name=E'%s' and type=E'%s' and domain_id=%d and content=E'%s'");
